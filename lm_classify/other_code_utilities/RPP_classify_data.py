...
for k in metadata['Unnamed: 0'].keys():
    ...
    content = open('../tagtog_annotations/annotations_original/tokenized_RPP/'+filename+'.txt', 'r').readlines()[3:]
...
json.dump(data, open("../data_processed/TA1_scienceparse_classify_data.json", 'w'))