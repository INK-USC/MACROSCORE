...
def get_data_iterators_repr(train_lm=False, map_cpu=False):
    ...
    train_examples, dev_examples, test_examples = get_examples_repr(data_path, train_lm, bert_tokenizer=bert_tokenizer)
...
def get_data_iterators_yelp(train_lm=False, map_cpu=False):
    ...
    path_format = './data/yelp_review_polarity_csv/%s.csv'
    bert_tokenizer = None
    if args.use_bert_tokenizer:
        bert_tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', do_lower_case=True, cache_dir='bert/cache')
