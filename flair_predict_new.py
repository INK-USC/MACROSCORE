...
test_data = json.load(open('./data_processed/P.json', 'r'))
pids = []
predictions = []
...
all_pred = {}
for id, sents in tqdm(enumerate(contents)):
...
with open("./flair_pred/extraction_result_p.csv", 'w') as f:
...
json.dump(output, open("./flair_pred/extraction_result_p.json", 'w'))
