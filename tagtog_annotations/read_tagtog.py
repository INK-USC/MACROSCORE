...
tagtog_dir = "./annotations_extra/plain.html/pool"
tagtog_annotation = "./annotations_extra/ann.json/master/pool"
...
for file in tagtog_list:
    ...
    with open("./annotations_extra/tokenized/"+doc_orig_name+'.txt', 'w') as f:
    ...
    if len(entities) == 0:
        os.remove("./annotations_extra/tokenized/"+doc_orig_name+'.txt')
