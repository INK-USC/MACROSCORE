...
if __name__ == "__main__":
    ...
    keep_variables = ['SS', 'TN', 'TE', 'SD', 'ES', 'PV', 'PR', 'SP', 'CT']
    annotated_dir = "./annotations_extra_with_citations/tokenized"
    annotated_files = os.listdir(annotated_dir)

    all_labels = open('./0_Labels.txt').readlines()[1:]
    ...
    json.dump(data, open("./data_extra.json", 'w'))